...
export default function Hints({ yourLocalBalance, mainnetProvider, price, address }: HintsProps) {
  // Get a list of tokens from a tokenlist -> see tokenlists.org!
  const [selectedToken, setSelectedToken] = useState<string>('Pick a token!');
